...
<div class="form-container">
    ...
    <form action="<%= request.getContextPath()%>/ressource?action=createressource" method="post">
        ...
        <div class="form-group">
            ...
            <textarea id="type" name="type" required></textarea>
        </div>
        <div class="form-group">
            <label for="quantite">quantite</label>
            <textarea id="quantite" name="quantite" required></textarea>
        </div>
        <div class="form-group">
            <label for="fournisseur">fournisseur</label>
            <textarea id="fournisseur" name="fournisseur" required></textarea>
        </div>

        <button type="submit" class="btn-submit">Ajouter Ressource</button>
    </form>
</div>
